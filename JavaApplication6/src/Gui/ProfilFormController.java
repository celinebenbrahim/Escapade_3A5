...
public class ProfilFormController implements Initializable {
    ...
    public void Profil(Utilisateur user) {
        this.tfNom.setText(user.getNom());
        this.tfPrenom.setText(user.getPrenom());
        ...
        this.tfDateNaissance.setValue(date);
        this.tfVille.setText(user.getVille());
        this.tfNumTel.setText(Integer.toString(this.user.getNumTel()));
    }

...
public class FactureService implements Iservice<Facture> {
    ...
    public void ajouter(Facture f) throws SQLException {
        ...
        try {
            ...
            pst.setDouble(1, f.getPrixTotal());
            pst.setInt(2, f.getClient().getId());
            pst.setDouble(3, f.getPrixFinal());
    ...
    public void modifier(Facture f, int id) throws SQLException {
        ...
        try {
            ...
            pst.setDouble(4, f.getPrixFinal());
    ...
    public List<Facture> afficher() throws SQLException {
        ...
        try {
            ...
            while (fs.next()) {
               ...
               // f.setId(fs.getInt("id"));
                f.setPrixTotal((fs.getDouble(1)));
                f.setDate(fs.getDate(2));
                f.setPrixFinal(fs.getDouble(3));
      ...
      public float CalculerPrixF(Facture f) throws SQLException
    {
